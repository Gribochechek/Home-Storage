	...
	class Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == comboBox_MakeChooser) {
				...
				oldMakeName = comboBox_MakeChooser.getSelectedItem().toString().trim().toLowerCase();
		...
		private void setResult() {
			...
			if (!oldMakeName.equals(temp_str.trim().toLowerCase())) {
			...
			tempMake = new AutomotiveParts_Make(AutomotiveParts_Make.getMakeIDByName(oldMakeName),
